...
const GoogleAuthButton = ({ onError, buttonText = "Continuer avec Google" }: GoogleAuthButtonProps) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full py-3 px-4 bg-white border-2 border-gray-200 text-gray-800 font-semibold rounded-lg hover:border-thunder-gold hover:bg-gray-50 disabled:opacity-60 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-3 mb-4"
    >
