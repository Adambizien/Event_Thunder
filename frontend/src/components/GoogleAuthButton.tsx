...
const GoogleAuthButton = ({ onError, buttonText = "Continuer avec Google" }: GoogleAuthButtonProps) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full py-3 px-4 bg-white/10 border border-white/20 text-white font-semibold rounded-lg hover:border-thunder-gold/60 hover:bg-white/15 disabled:opacity-60 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-3 mb-4"
    >
